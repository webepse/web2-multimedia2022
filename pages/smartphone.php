<?php 
   $reqcount = $bdd->query("SELECT id FROM produits WHERE type='Smartphone'");
...
<div class="container">
    <?php
        ...
        $req = $bdd->prepare("SELECT * FROM produits WHERE type='Smartphone' ORDER BY id DESC LIMIT :offset,:limit");
    ...
    <?php
        ...
        if($pg>1)
        {
            echo " &nbsp;<a href='index.php?action=smartphone&page=".($pg-1)."'> < </a>";
        }
        echo "Page ".$pg." ";
        if($pg!=$nbpage)
        {
